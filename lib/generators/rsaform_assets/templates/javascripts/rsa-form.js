...
*/  
  ...
  $("#rsa_login_form").jCryption( {getKeysURL:"/rsakey", formFieldSelector:':input:not([name=authenticity_token])',
  ...
  */
  ...
  function validateString( str, options) 
  {
    ...
    var o = {
      ...
      noQwertySequences: false,   // prohibit conseq chars on keyboard (qwerty)
